...
<section class="checkout-orders">
   ...
   <h3>Your Orders</h3>
      ...
      ?>
         ...
         <div class="grand-total">Grand Total : <span>TK.<?= $grand_total; ?>/-</span></div>
      </div>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>District:</span>
            <input type="text" name="state" placeholder="Dhaka" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>Country :</span>
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" name="pin_code" placeholder="e.g. 1212" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
